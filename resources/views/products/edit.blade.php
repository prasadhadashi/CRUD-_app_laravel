                    ...
                    <form enctype="multipart/form-data" action="{{ route('products.update',$product->id) }}" method="post">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea value="{{ old('description',$product->description) }}" class="form-control" placeholder="Discription" name="description" id="" cols="30" rows="5"></textarea>
                            </div>
                            <div class="mb-3">
                                <label class="form-label h5" for="">Image</label>
                                <input type="file" class="form-control form-control-lg" placeholder="Image" name="image">
                                    @if ($product->image != "")
                                        <img class="w-50 my-2" src="{{ asset('uploads/products/'.$product->image) }}" alt="image">
                                    @endif
                            </div>
                            <div class="d-grid">
